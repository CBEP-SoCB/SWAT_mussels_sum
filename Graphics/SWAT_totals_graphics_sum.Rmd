...
## Trend Graphic
```{r pah_trend_graphic, fig.width = 6, fig.height = 4}
plt <- pah_trend_data %>%
  filter(parameter == 'pah40') %>%
...
```{r pah_trend_graphic_annot, fig.width = 6, fig.height = 4}
plt +
  geom_hline(yintercept = 1674, lty = 2,
             color = cbep_colors2()[1],
             lwd = 0.5) +
...
```{r pcb_graphic, fig.width = 6, fig.height = 4}
plt <- pcb_recent_data %>%
...
```{r pcb_trend_add_annotations, fig.width = 6, fig.height = 4}
plt +
  geom_hline(yintercept = 141, lty = 2,
             color = cbep_colors2()[1],
             lwd = 0.5) +
