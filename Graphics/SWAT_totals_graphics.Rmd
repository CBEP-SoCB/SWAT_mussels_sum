...
message.
```{r pah_graphic, fig.width = 5, fig.height = 4}
plt <- pah_recent_data %>%
...
```
### Add Annotations
```{r pah_add_annotations, fig.width = 5, fig.height = 4}
...
```{r pah_trend_add_annotations, fig.width = 5, fig.height = 4}
...
```{r pcb_graphic, fig.width = 5, fig.height = 4}
plt <- pcb_recent_data %>%
...
```{r pcb_add_annotations, fig.width = 5, fig.height = 4}
